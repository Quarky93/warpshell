...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.PF0_DEVICE_ID_mqdma {9041} \
   CONFIG.PF0_SRIOV_VF_DEVICE_ID {A041} \
   CONFIG.PF1_SRIOV_VF_DEVICE_ID {A141} \
   CONFIG.PF2_DEVICE_ID_mqdma {9241} \
   CONFIG.PF2_SRIOV_VF_DEVICE_ID {A241} \
   CONFIG.PF3_DEVICE_ID_mqdma {9341} \
   CONFIG.PF3_SRIOV_VF_DEVICE_ID {A341} \
