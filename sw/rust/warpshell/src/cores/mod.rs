...
//!
//! An `If` trait is only required in cores which provide multiple interfaces to the host. In the
//! case of [HBICAP](`hbicap`) those are one AXI-Lite control interface and one AXI-MM DMA
